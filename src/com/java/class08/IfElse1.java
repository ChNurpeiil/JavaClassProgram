...
public class IfElse1 {
    public static void main(String[] args) {
        ...
        //first goal is make sure the program works fine for the customers

        //the second goal is to make sure the program is written in a most
        //space (memory) and performance (speed ) efficient
        ...
        //if it's false the program jumps to else and the body of else, the program
        //doesn't have to check the else (there is even no logic there)
        if (doesHaveLicense){
            System.out.println("Have a safe Trip!");
        }
        else {
        ...
        //is the anything you want the program to do
